...
### 🎬 シーン4用（ロゴ用背景）
`A clean, warm orange and soft teal color gradient background with a glassmorphism aesthetic. Minimalist and modern. Gentle, slow abstract motion. No text, absolutely blank. 4k.`

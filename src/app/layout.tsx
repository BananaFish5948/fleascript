    ...
    <html lang="ja" className={`${zenMaruGothic.className} h-full`}>
      <body className="min-h-full flex flex-col antialiased relative overflow-x-hidden">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          ...
          />
          {/* 木漏れ日のような環境光（ゆっくり漂う） */}
          <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-stone-300/30 blur-[100px] animate-ambient-1" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-orange-100/40 blur-[120px] animate-ambient-2" />
        </div>
